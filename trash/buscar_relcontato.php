...
<div class="box box-header-black">
    <h3 class="header"><span class="header-2"><span class="header-3"><span class="color">:: Busca de Contato ::</span></span></span></h3>
                            ...
                            <div class="box-3">
                                ...
                                <form method="get" action="index.php">
                                    ...
                                    <p>
                                        ...
                                        <input type="hidden" name="acao" value="contato listarrel">
                                    </p>
