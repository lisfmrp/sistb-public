                            ...
                            <div class="box-3">
                               ...
                               $nome_un_not = $consultan[0]['nome'];}
								...
								<div itemscope="" itemtype="http://sistb-dev.ddns.net/d2rq/vocab/Tratamento">
									<b>Data de notificação: </b><span itemprop="data_notificacao"><?= $data_notificacao1; ?></span><br/>
									...
									<b>Unidade de supervisão: </b><span itemprop="unidade_supervisao"><?= $nome_un_sup; ?></span><br/>
									...
									<b>Se encaminhado, foi recebido de unidade e/ou município: </b><span itemprop="recebido_unidade"><?= $recebido; ?></span> / <?= $outra_unidade_recebe; ?><br/>
									...
									foreach ($consultas2 as $consulta2) {
										...
										<b>Observações: </b><span itemprop="tratamento_observacoes"><?= $observacoes; ?></span><br/>
                                ...
                                <?php if ($encerrado == "Não") { ?>
                                    ...
                                    <form method="post" class="validar" action="editar_tratamento.php">
                                        ...
                                        <div style="width: 100%; height:100px;">
                                            <div  style="width: 30%; float:left">
                                                ...
                                                <?php
                                                $selectpro = "SELECT cod_profissional, nome from profissional WHERE ocupacao='Médico' ORDER BY nome";
                                            ...
                                            <?php if ($encerrado == "Não") { ?>
                                                <div  style="width: 30%; float:left">
                                                    ...
                                                    <select name="encerrado"> 
                                                        ...
                                                        <option selected ="0" value="0">Não</option>
                                        ...
                                        <div style="width: 100%; height:100px;">
                                            ...
                                            <div  style="width: 30%; float:left">
                                                ...
                                                <label>Data de notificação (dd/mm/aaaa) (*): </label><br/>
                                            ...
                                            <div  style="width: 30%; float:left">
                                                ...
                                                <label>Data de início do tratamento atual(dd/mm/aaaa) (*): </label><br/>
                                            ...
                                            <?php if ($tipo_trat == "Auto administrado") { ?>
                                                ...
                                                <?php
                                            } else if ($tipo_trat == "Sem informação") {
                                                ?>
                                                ...
                                                <div  style="width: 30%; float:left">
                                                    ...
                                                    <select name="tipo_trat"> 
                                                        <option value="Auto administrado">Auto administrado</option>
                                                        <option value="Supervisionado">Supervisionado</option>
                                                        <option selected = "Sem informação" value="Sem informação">Sem informação</option>                     
                                                    </select>	 
                                                </div>
                                                <?php
                                            } else {
                                        ...
                                        <div style="width: 100%; height:100px;">
                                            ...
                                            <?php
                                            if ($trat_anterior == "Não Tratou") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Tratamento Anterior:</label><br/>
                                                    <select name="trat_anterior"> 
                                                        <option selected ="Não Tratou" value="Não Tratou">Não Tratou</option>
                                                ...
                                                <div  style="width: 30%; float:left">
                                                    <label>Tratamento Anterior:</label><br/>
                                                    <select name="trat_anterior"> 
                                                        <option value="Não Tratou">Não Tratou</option>
                                                ...
                                                <?php
                                            } else if ($trat_anterior == "Não sabe") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Tratamento Anterior:</label><br/>
                                                    <select name="trat_anterior"> 
                                                        ...
                                                        <option value="Sim, alta cura">Sim, alta cura</option>
                                                        <option value="Sim, alta abandono">Sim, alta abandono</option>
                                                        <option selected ="Não sabe" value="Não sabe">Não sabe</option> 
                                                        <option value="Sem informação">Sem informação</option>
                                                    </select>				
                                                </div>
                                                <?php
                                            } else if ($trat_anterior == "Sem informação") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Tratamento Anterior:</label><br/>
                                                    <select name="trat_anterior"> 
                                            ...
                                            <div  style="width: 30%; float:left">
                                                <label>Tratou há quanto tempo</label><br/>
                                            ...
                                            if ($fc1 == "Pulmonar") {
                                                ...
                                                <div  style="width: 30%; float:left">
                                                    ...
                                                    <select name="fc1"> 
                                                        ...
                                                        <option value="Meningite">Meningite</option>
                                                        <option value="Pleural">Pleural</option>
                                                        <option selected ="Glang. Periférica" value="Glang. Periférica">Glang. Periférica</option> 
                                                        <option value="Óssea">Óssea</option>                                            
                                                        <option value="Vias Urinárias">Vias Urinárias</option>
                                                        <option value="Genital">Genital</option>
                                                        <option value="Intestinal">Intestinal</option>
                                                ...
                                                <div  style="width: 30%; float:left">
                                                    ...
                                                    <select name="fc1"> 
                                                        ...
                                                        <option value="Pleural">Pleural</option>
                                                        <option value="Glang. Periférica">Glang. Periférica</option>  
                                                        <option selected ="Óssea" value="Óssea">Óssea</option>                                            
                                                        <option value="Vias Urinárias">Vias Urinárias</option>
                                                        <option value="Genital">Genital</option>
                                                        <option value="Intestinal">Intestinal</option>
                                                        <option value="Oftalmica">Oftalmica</option> 
                                                ...
                                                <div  style="width: 30%; float:left">
                                                    ...
                                                    <select name="fc1"> 
                                                        ...
                                                        <option value="Glang. Periférica">Glang. Periférica</option> 
                                                        <option value="Óssea">Óssea</option>                                            
                                                        <option selected ="Vias Urinárias" value="Vias Urinárias">Vias Urinárias</option>
                                                        <option value="Genital">Genital</option>
                                                        <option value="Intestinal">Intestinal</option>
                                                        <option value="Oftalmica">Oftalmica</option> 
                                                        <option value="Pele">Pele</option>                      
                                            ...
                                            <?php } else if ($fc1 == "Pericárdia") { ?>
                                                <div  style="width: 30%; float:left">
                                                    ...
                                                    <select name="fc1"> 
                                                        ...
                                                        <option selected ="Pericárdia" value="Pericárdia">Pericardia</option>
                                            ...
                                            <?php } else if ($fc1 == "Genitourinária") { ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Forma Clínica :</label><br/>
                                                    <select name="fc1"> 
                                                        <option value="Pulmonar">Pulmonar</option>
                                                        ...
                                                        <option selected ="Genitourinária" value="Genitourinária">Genitourinária</option>
                                                        <option value="Ocular">Ocular</option>
                                                        <option value="Otorrinolaringológica">Otorrinolaringológica</option>
                                                        <option value="Mamária">Mamária</option>
                                                        <option value="Nasal">Nasal</option>
                                            ...
                                            <?php } else if ($fc1 == "Otorrinolaringológica") { ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Forma Clínica :</label><br/>
                                                    <select name="fc1"> 
                                                        <option value="Pulmonar">Pulmonar</option>
                                                        ...
                                                        <option value="Genitourinária">Genitourinária</option>
                                                        <option value="Ocular">Ocular</option>
                                                        <option selected="Otorrinolaringológica" value="Otorrinolaringológica">Otorrinolaringológica</option>
                                                        <option value="Mamária">Mamária</option>
                                                        <option value="Nasal">Nasal</option>
                                                        <option value="Laríngea">Laríngea</option>
                                                        <option value="Pleural">Pleural</option>
                                            ...
                                            <?php } else if ($fc1 == "Mamária") { ?>
                                                <div  style="width: 30%; float:left">
                                                    ...
                                                    <select name="fc1"> 
                                                        ...
                                                        <option value="Ocular">Ocular</option>
                                                        <option value="Otorrinolaringológica">Otorrinolaringológica</option>
                                                        <option selected ="Mamária" value="Mamária">Mamária</option>
                                                        <option value="Nasal">Nasal</option>
                                                        <option value="Laríngea">Laríngea</option>
                                                        <option value="Pleural">Pleural</option>
                                                        <option value="Glang. Periférica">Glang. Periférica</option> 
                                            ...
                                            <?php } else if ($fc1 == "Laríngea") { ?>
                                                <div  style="width: 30%; float:left">
                                                    ...
                                                    <select name="fc1"> 
                                                        ...
                                                        <option value="Mamária">Mamária</option>
                                                        <option value="Nasal">Nasal</option>
                                                        <option selected="Laríngea" value="Laríngea">Laríngea</option>
                                                        <option value="Pleural">Pleural</option>
                                                        <option value="Glang. Periférica">Glang. Periférica</option> 
                                                        <option value="Óssea">Óssea</option>                                            
                                                        <option value="Vias Urinárias">Vias Urinárias</option>
                                        ...
                                        <div style="width: 100%; height:100px;">
                                            ...
                                            if ($fc2 == "Pulmonar") {
                                                ...
                                                <div  style="width: 30%; float:left">
                                                    <label>Forma Clínica 2:</label><br/>
                                                    <select name="fc2"> 
                                                        <option selected="Pulmonar" value="Pulmonar">Pulmonar</option>
                                                        <option value="Meningite">Meningite</option>
                                                        <option value="Pleural">Pleural</option>
                                            ...
                                            <?php } else if ($fc2 == "Genitourinária") { ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Forma Clínica 2:</label><br/>
                                                    <select name="fc2"> 
                                                        <option value="Pulmonar">Pulmonar</option>
                                            ...
                                            <?php } else if ($fc2 == "Otorrinolaringológica") { ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Forma Clínica 2:</label><br/>
                                                    <select name="fc2"> 
                                                        <option value="Pulmonar">Pulmonar</option>
                                            ...
                                            if ($fc3 == "Pulmonar") {
                                                ...
                                                <div  style="width: 30%; float:left">
                                                    <label>Forma Clínica 3:</label><br/>
                                                    <select name="fc3"> 
                                                        <option selected="Pulmonar" value="Pulmonar">Pulmonar</option>
                                                        <option value="Meningite">Meningite</option>
                                                        <option value="Pleural">Pleural</option>
                                            ...
                                            <?php } else if ($fc3 == "Genitourinária") { ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Forma Clínica 3:</label><br/>
                                                    <select name="fc3"> 
                                                        <option value="Pulmonar">Pulmonar</option>
                                            ...
                                            <?php } else if ($fc3 == "Otorrinolaringológica") { ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Forma Clínica 3:</label><br/>
                                                    <select name="fc3"> 
                                                        <option value="Pulmonar">Pulmonar</option>
                                            ...
                                            <?php
                                            if ($descoberta == "Apres. espontânea com sintomas respiratórios") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Tipo de Descoberta:</label><br/>
                                                    <select name="descoberta"> 
                                                        <option selected ="Apres. espontânea com sintomas respiratórios" value="Apres. espontânea com sintomas respiratórios">Apres. espontânea com sintomas respiratórios</option>
                                                        <option value="Apres. espontânea por outros motivos">Apres. espontânea por outros motivos</option>
                                                        <option value="Encaminhado com suspeita ou diagnóstico de TB">Encaminhado com suspeita ou diagnóstico de TB</option>
                                                        <option value="Controle de comunicantes">Controle de comunicantes</option> 
                                                        <option value="Descoberto após óbito">Descoberto após óbito</option>   
                                                    </select>				
                                                </div>
                                                <?php
                                            } else if ($descoberta == "Apres. espontânea por outros motivos") {
                                                ?>

                                                <div  style="width: 30%; float:left">
                                                    <label>Tipo de Descoberta:</label><br/>
                                                    <select name="descoberta"> 
                                                        <option value="Apres. espontânea com sintomas respiratórios">Apres. espontânea com sintomas respiratórios</option>
                                                        <option selected ="Apres. espontânea por outros motivos" value="2- Apres. espontânea por outros motivos">Apres. espontânea por outros motivos</option>
                                                        <option value="Encaminhado com suspeita ou diagnóstico de TB">Encaminhado com suspeita ou diagnóstico de TB</option>
                                                        <option value="Controle de comunicantes">Controle de comunicantes</option> 
                                                        <option value="Descoberto após óbito">Descoberto após óbito</option>   
                                                    </select>				
                                                ...
                                                <?php
                                            } else if ($descoberta == "Encaminhado com suspeita ou diagnóstico de TB") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Tipo de Descoberta:</label><br/>
                                                    <select name="descoberta"> 
                                                        <option value="Apres. espontânea com sintomas respiratórios">Apres. espontânea com sintomas respiratórios</option>
                                                        <option value="Apres. espontânea por outros motivos">Apres. espontânea por outros motivos</option>
                                                        <option selected ="Encaminhado com suspeita ou diagnóstico de TB" value="Encaminhado com suspeita ou diagnóstico de TB">Encaminhado com suspeita ou diagnóstico de TB</option>
                                                        <option value="Controle de comunicantes">Controle de comunicantes</option> 
                                                        <option value="Descoberto após óbito">Descoberto após óbito</option>   
                                                    </select>				
                                                </div>
                                            ...
                                            if ($descoberta == "Controle de comunicantes") {
                                                ...
                                                <?php
                                            } else if ($descoberta == "Descoberto após óbito") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Tipo de Descoberta:</label><br/>
                                                    <select name="descoberta"> 
                                                        ...
                                                        <option value="Encaminhado com suspeita ou diagnóstico de TB">Encaminhado com suspeita ou diagnóstico de TB</option>
                                                        <option value="Controle de comunicantes">Controle de comunicantes</option> 
                                                        <option selected ="Descoberto após óbito" value="Descoberto após óbito">Descoberto após óbito</option>   
                                                    </select>				
                                                </div>
                                                <?php
                                            } else {
                                        ...
                                        <div style="width: 100%; height:100px;">
                                            ...
                                            <div  style="width: 30%; float:left">
                                                <label>Outras unidades e/ou município que foi recebido:</label><br/>
                                                <input type="text" value="<?= $outra_unidade_recebe; ?>" class="text small" name="outra_unidade_recebe" /> 
                                            </div>


                                            <?php
                                            if ($servico == "Ambulatório de referência") {
                                                ?>

                                                <div  style="width: 30%; float:left">
                                                    <label>Serviço que descobriu o caso:</label><br/>
                                                    <select name="servico"> 
                                                        <option selected ="Ambulatório de referência" value="Ambulatório de referência">Ambulatório de referência</option>
                                                        <option value="Pronto atendimento">Pronto atendimento</option>
                                                        <option value="Ambulatório privado">Ambulatório privado</option>
                                            ...
                                            if ($servico == "Pronto atendimento") {
                                                ...
                                                <div  style="width: 30%; float:left">
                                                    <label>Serviço que descobriu o caso:</label><br/>
                                                    <select name="servico"> 
                                                        <option value="Ambulatório de referência">Ambulatório de referência</option>
                                            ...
                                            if ($servico == "Ambulatório privado") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Serviço que descobriu o caso:</label><br/>
                                                    <select name="servico"> 
                                                        <option selected ="Ambulatório de referência" value="Ambulatório de referência">Ambulatório de referência</option>
                                                        <option value="Pronto atendimento">Pronto atendimento</option>
                                                        <option selected = "Ambulatório privado" value="Ambulatório privado">Ambulatório privado</option>
                                                        <option value="Hospital público">Hospital público</option> 
                                                        <option value="Hospital privado">Hospital privado</option>
                                                        <option value="Atenção básica">Atenção básica</option> 
                                                        <option value="Outro">Outro</option>   
                                            ...
                                            if ($servico == "Hospital público") {
                                                ...
                                                <div  style="width: 30%; float:left">
                                                    ...
                                                    <select name="servico"> 
                                                        ...
                                                        <option value="Pronto atendimento">Pronto atendimento</option>
                                                        <option value="Ambulatório privado">Ambulatório privado</option>
                                                        <option selected = "Hospital público" value="Hospital público">Hospital público</option> 
                                                        <option value="Hospital privado">Hospital privado</option>
                                                        <option value="Atenção básica">Atenção básica</option> 
                                                        <option value="Outro">Outro</option>   
                                                        <option value="Sem informação">Sem informação</option>   
                                            ...
                                            if ($servico == "Atenção básica") {
                                                ...
                                                <div  style="width: 30%; float:left">
                                                    ...
                                                    <select name="servico"> 
                                                        ...
                                                        <option value="Hospital público">Hospital público</option> 
                                                        <option value="Hospital privado">Hospital privado</option>
                                                        <option selected = "Atenção básica" value="Atenção básica">Atenção básica</option> 
                                                        <option value="Outro">Outro</option>   
                                                        <option value="Sem informação">Sem informação</option>   
                                                    </select>				
                                                </div>
                                        ...
                                        <div style="width: 100%; height:100px;">
                                            ...
                                            <div  style="width: 50%; float:left">
                                                <label>Tempo decorrido do início dos sintomas ao tratamento, em semanas (*):</label><br/>
                                    ...
                                    <label>Exames complementares</label><br/>
                                        ...
                                        <div style="width: 100%; height:100px;">
                                            ...
                                            if ($resultado_bac_escarro == "Não realizado") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Baciloscopia de escarro:</label><br/>
                                                    <select name="resultado_bac_escarro"> 
                                                        ...
                                                        <option value="Negativo">Negativo</option>
                                                        <option value="Em andamento">Em andamento</option>
                                                        <option selected ="Não realizado" value="Não realizado">Não realizado</option> 
                                                        <option value="Sem informação">Sem informação</option>                          
                                                    </select>	 
                                                </div>
                                                <?php
                                            } else
                                            if ($resultado_bac_escarro == "Sem informação") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Baciloscopia de escarro:</label><br/>
                                                    <select name="resultado_bac_escarro"> 
                                         ...
                                         <div style="width: 100%; height:100px;">
                                            ...
                                            if ($resultado_bac_outro == "Não realizado") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Baciloscopia outro material:</label><br/>
                                                    <select name="resultado_bac_outro"> 
                                            ...
                                            if ($resultado_bac_outro == "Sem informação") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Baciloscopia outro material:</label><br/>
                                                    <select name="resultado_bac_outro"> 
                                                        ...
                                                        <option value="Em andamento">Em andamento</option>
                                                        <option value="Não realizado">Não realizado</option> 
                                                        <option selected ="em informação" value="Sem informação">Sem informação</option>                          
                                                    </select>	 
                                                </div>
                                                <?php
                                            } else {
                                    ...
                                    <div style="width: 100%; height:100px;">
                                            ...
                                            if ($resultado_cultura_escarro == "Não realizado") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Cultura de escarro:</label><br/>
                                                    <select name="resultado_cultura_escarro"> 
                                            ...
                                            if ($resultado_cultura_escarro == "Sem informação") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Cultura de escarro:</label><br/>
                                                    <select name="resultado_cultura_escarro"> 
                                         ...
                                         <div style="width: 100%; height:100px;">
                                            ...
                                            if ($resultado_cultura_outro == "Não realizado") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Cultura outro material:</label><br/>
                                                    <select name="resultado_cultura_outro"> 
                                            ...
                                            if ($resultado_cultura_outro == "Sem informação") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Cultura outro material:</label><br/>
                                                    <select name="resultado_cultura_outro"> 
                                    ...
                                    <div style="width: 100%; height:100px;">
                                            ...
                                            if ($resultado_rx_torax == "Normal") {
                                                ...
                                                <div  style="width: 30%; float:left">
                                                    ...
                                                    <select name="resultado_rx_torax"> 
                                                        ...
                                                        <option value="Outras afecções">Outras afecções</option> 
                                                        <option value="Não realizado">Não realizado</option>         
                                                        <option value="Sem informação">Sem informação</option> 
                                                    </select>	 
                                                </div>
                                            ...
                                            if ($resultado_rx_torax == "Suspeita de TB") {
                                                ...
                                                <div  style="width: 30%; float:left">
                                                    ...
                                                    <select name="resultado_rx_torax"> 
                                                        ...
                                                        <option value="Suspeita de TB com caverna">Suspeita de TB com caverna</option>
                                                        <option value="Outras afecções">utras afecções</option> 
                                                        <option value="Não realizado">Não realizado</option>         
                                                        <option value="Sem informação">Sem informação</option> 
                                                    </select>	 
                                                </div>
                                            ...
                                            if ($resultado_rx_torax == "Outras afecções") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>RX de tórax:</label><br/>
                                                    <select name="resultado_rx_torax"> 
                                                        ...
                                                        <option value="Suspeita de TB">Suspeita de TB</option>
                                                        <option value="Suspeita de TB com caverna">Suspeita de TB com caverna</option>
                                                        <option selected ="Outras afecções" value="4- Outras afecções">Outras afecções</option> 
                                                        <option value="Não realizado">Não realizado</option>         
                                                        <option value="Sem informação">Sem informação</option> 
                                                    </select>	 
                                                </div>
                                            ...
                                            if ($resultado_rx_torax == "Não realizado") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>RX de tórax:</label><br/>
                                                    <select name="resultado_rx_torax"> 
                                            ...
                                            if ($resultado_rx_torax == "Sem informação") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>RX de tórax:</label><br/>
                                                    <select name="resultado_rx_torax"> 
                                            ...
                                            <div  style="width: 30%; float:left">
                                                <label>Data do Resultado RX de Tórax (dd/mm/aaaa): </label><br/>
                                    ...
                                    <div style="width: 100%; height:100px;">
                                            ...
                                            if ($resultado_rx_outro == "Outras afecções") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>RX outro:</label><br/>
                                                    <select name="resultado_rx_outro"> 
                                                        ...
                                                        <option value="Suspeita de TB">Suspeita de TB</option>
                                                        <option value="Suspeita de TB com caverna">Suspeita de TB com caverna</option>
                                                        <option selected="Outras afecções" value="Outras afecções">Outras afecções</option> 
                                                        <option value="Não realizado">Não realizado</option>         
                                                        <option value="Sem informação">Sem informação</option>
                                                    </select>	 
                                                </div>
                                            ...
                                            if ($resultado_rx_outro == "Não realizado") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>RX outro:</label><br/>
                                                    <select name="resultado_rx_outro"> 
                                            ...
                                            if ($resultado_rx_outro == "Sem informação") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>RX outro:</label><br/>
                                                    <select name="resultado_rx_outro"> 
                                        ...
                                        <div style="width: 100%; height:100px;">
                                            ...
                                            if ($resultado_histopatologico == "Não sugestivo TB") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Histopatológico:</label><br/>
                                                    <select name="resultado_histopatologico"> 
                                                        <option value="Sugestivo de TB">Sugestivo de TB</option>
                                                        <option selected="Não sugestivo de TB" value="Não sugestivo TB">Não sugestivo TB</option>
                                                        <option value="Não realizado">Não realizado</option>
                                                        <option value=" Sem informação">Sem informação</option>                          
                                                    </select>	 
                                                </div>
                                            ...
                                            if ($resultado_histopatologico == "Não realizado") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Histopatológico:</label><br/>
                                                    <select name="resultado_histopatologico"> 
                                            ...
                                            if ($resultado_histopatologico == "Sem informação") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Histopatológico:</label><br/>
                                                    <select name="resultado_histopatologico"> 
                                            ...
                                            <div  style="width: 30%; float:left">
                                                <label>Data do Resultado de Histopatológico (dd/mm/aaaa): </label><br/>
                                    ...
                                    <div style="width: 100%; height:100px;">
                                            ...
                                            if ($resultado_necropsia == "Não sugestivo TB") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Necrópsia:</label><br/>
                                                    <select name="resultado_necropsia"> 
                                            ...
                                            if ($resultado_necropsia == "Não realizado") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Necrópsia:</label><br/>
                                                    <select name="resultado_necropsia"> 
                                            ...
                                            if ($resultado_necropsia == "Sem informação") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Necrópsia:</label><br/>
                                                    <select name="resultado_necropsia"> 
                                    ...
                                    <div style="width: 100%; height:100px;">
                                        ...
                                        <?php
                                            if ($resultado_tmrtb == "Positivo") {
                                                ?>		
                                                <div  style="width: 30%; float:left">
                                                    <label>Teste molecular rápido para TB (TMR-TB):</label><br/>
                                            ...
                                            if ($resultado_tmrtb == "Não realizado") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Teste molecular rápido para TB (TMR-TB):</label><br/>
                                                    <select name="resultado_tmrtb"> 
                                    ...
                                    <div style="width: 100%; height:100px;">
                                            ...
                                            if ($da1 == "AIDS") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Doenças associadas:</label><br/>
                                                    <select name="da1"> 
														...
														<option value="Doença Mental">Doença Mental</option>   
														<option value="Drogadição">Drogadição</option> 
														<option value="Outra Imunossupressão">Outra Imunossupressão</option> 											
                                                ...
                                                <div  style="width: 30%; float:left">
                                                    ...
                                                    <select name="da1"> 
                                                       <option value="AIDS">AIDS</option>
														...
														<option value="Alcoolismo">Alcoolismo</option>
														<option value="Tabagismo">Tabagismo</option>
														<option selected = "Hipertensão" value="Hipertensão">Hipertensão</option>
														<option value="Câncer">Câncer</option>
														<option value="Doença Mental">Doença Mental</option>   
														<option value="Drogadição">Drogadição</option> 
														<option value="Outra Imunossupressão">Outra Imunossupressão</option> 											
                                            ...
                                            <?php } else if ($da1 == "Câncer") { ?>
                                                <div  style="width: 30%; float:left">
                                                    ...
                                                    <select name="da1"> 
														...
														<option value="Tabagismo">Tabagismo</option>
														<option value="Hipertensão">Hipertensão</option>
														<option selected = "Câncer"value="Câncer">Câncer</option>
														<option value="Doença Mental">Doença Mental</option>   
														<option value="Drogadição">Drogadição</option> 
														<option value="Outra Imunossupressão">Outra Imunossupressão</option> 											
														<option value="Outra">Outra</option>
                                            ...
                                            <?php } else if ($da1 == "Doença Mental") {
                                                ...
                                                <div  style="width: 30%; float:left">
                                                    ...
                                                    <select name="da1"> 
														...
														<option value="Hipertensão">Hipertensão</option>
														<option value="Câncer">Câncer</option>
														<option selected = "Doença Mental" value="Doença Mental">Doença Mental</option>   
														<option value="Drogadição">Drogadição</option> 
														<option value="Outra Imunossupressão">Outra Imunossupressão</option> 											
														<option value="Outra">Outra</option>
														<option value="Nenhuma">Nenhuma</option>
                                            ...
                                            if ($da1 == "Drogadição") {
                                                ...
                                                <div  style="width: 30%; float:left">
                                                    ...
                                                    <select name="da1"> 
														...
														<option value="Câncer">Câncer</option>
														<option value="Doença Mental">Doença Mental</option>   
														<option selected = "Drogadição" value="Drogadição">Drogadição</option> 
														<option value="Outra Imunossupressão">Outra Imunossupressão</option> 											
														<option value="Outra">Outra</option>
														<option value="Nenhuma">Nenhuma</option>
														<option value="Sem informação">Sem informação</option>                       
                                            ...
                                            if ($da1 == "Outra Imunossupressão") {
                                                ...
                                                <div  style="width: 30%; float:left">
                                                    ...
                                                    <select name="da1"> 
														...
														<option value="Doença Mental">Doença Mental</option>   
														<option value="Drogadição">Drogadição</option> 
														<option selected = "Outra Imunossupressão" value="Outra Imunossupressão">Outra Imunossupressão</option> 											
														<option value="Outra">Outra</option>
														<option value="Nenhuma">Nenhuma</option>
														<option value="Sem informação">Sem informação</option>                       
                                                    </select>	 
                                            ...
                                            if ($da2 == "AIDS") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Doenças associadas 2: </label><br/>
                                                    <select name="da2"> 
                                                        <option selected ="AIDS" value="AIDS">AIDS</option>
                                                        <option value="Diabetes">Diabetes</option>
														<option value="Alcoolismo">Alcoolismo</option>
                                            ...
                                            if ($da3 == "AIDS") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Doenças associadas 3:</label><br/>
                                                    <select name="da3"> 
                                                        <option selected ="AIDS" value="AIDS">AIDS</option>
                                                        <option value="Diabetes">Diabetes</option>
														<option value="Alcoolismo">Alcoolismo</option>
                                        ...
                                        <div style="width: 100%; height:100px;">
                                            ...
                                            if ($droga == "S") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Drogas no início do tratamento:</label><br/>
                                                    <select name="droga"> 
                                            ...
                                            if ($droga == "N") {
                                                ...
                                                <div  style="width: 30%; float:left">
                                                    ...
                                                    <select name="droga"> 
                                                        ...
                                                        <option selected ="N" value="N">Não</option>                 
                                                    </select>
                                                </div>
                                                <?php
                                            } else {
                                        ...
                                        <div style="width: 100%; height:100px;">
                                            ...
                                            if ($alta == "Óbito por TB") {
                                                ...
                                                <div  style="width: 30%; float:left">
                                                    ...
                                                    <select name="alta"> 
                                                        <option value="Cura">Cura</option>                 
                                                        <option value="Abandono">Abandono</option>
                                                        <option selected ="Óbito por TB" value="Óbito por TB">Óbito por TB</option>  
                                                        <option value="Óbito por outras causas">Óbito por outras causas</option>                 
                                                        <option value="Transferência">Transferência</option>
                                                        <option value="Mudança de diagnóstico">Mudança de diagnóstico</option>  
                                                    </select>
                                            ...
                                            if ($alta == "Óbito por outras causas") {
                                                ?>
                                                <div  style="width: 30%; float:left">
                                                    <label>Alta:</label><br/>
                                                    <select name="alta"> 
                                                        ...
                                                        <option value="Abandono">Abandono</option>
                                                        <option value="Óbito por TB">Óbito por TB</option>  
                                                        <option selected ="Óbito por outras causas" value="Óbito por outras causas">Óbito por outras causas</option>                 
                                                        <option value="Transferência">Transferência</option>
                                                        <option value="Mudança de diagnóstico">Mudança de diagnóstico</option>  
                                                    </select>
                                                </div>
                                            ...
                                            if ($alta == "Transferência") {
                                                ...
                                                <div  style="width: 30%; float:left">
                                                    ...
                                                    <select name="alta"> 
                                                        ...
                                                        <option value="Óbito por TB">Óbito por TB</option>  
                                                        <option value="Óbito por outras causas">Óbito por outras causas</option>                 
                                                        <option selected ="Transferência" value="Transferência">Transferência</option>
                                                        <option value="Mudança de diagnóstico">Mudança de diagnóstico</option>  
                                                    </select>
                                                </div>
                                                <?php
                                            ...
                                            if ($alta == "N") {
                                                ...
                                                <div  style="width: 30%; float:left">
                                                    ...
                                                    <select name="alta"> 
                                                        ...
                                                        <option value="Óbito por outras causas">Óbito por outras causas</option>                 
                                                        <option value="Transferência">Transferência</option>
                                                        <option selected ="" value="Mudança de diagnóstico">Mudança de diagnóstico</option>  
                                                    </select>
                                                </div>
                                                <?php
                                            } else {
                                        ...
                                        <div style="width: 100%; height:100px;">
                                        <div  style="width: 30%; float:left">    
                                        <label>Mudança de drogas no decorrer do tratamento:</label><br/>
                                        ...
                                        <div  style="width: 30%; float:left">                                              
                                            <label id="labelData" style="display:none">Data da mudança de drogas:</label><br/>
