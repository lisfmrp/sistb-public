...
<div class="box box-header-black">
    <h3 class="header"><span class="header-2"><span class="header-3"><span class="color">:: Busca ::</span></span></span></h3>
                        ...
                        <div class="box-2">
                            <div class="box-3">
                                ...
                                <form method="get" action="index.php">
                                    ...
                                    <p>
                                        <label>***OBSERVAÇÃO: Preencher todos os campos!</label></br>
                                    </p>
                                    
                                                                 
                                    <p>
                                        <label>Mês da supervisão (*):</label><br/>
                                        <select name="busca" class="required"> 
                                            
                                            <option selected = "Janeiro" value="01">Janeiro</option>
                                        ...
                                        <input type="hidden" name="acao" value="supervisionamento mostrar_mes">
                                    </p>
                                    
                                    <p>
                                        <label>Ano (*):</label><br/>
                                        <input type="text"  class="text small required" name="busca2" /> 
                                    </p>    
