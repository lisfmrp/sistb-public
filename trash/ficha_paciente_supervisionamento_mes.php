                    ...
                    <div class="box-1">
                        <div class="box-2">
                            <div class="box-3">
                                ...
                                $cod_pac = $conteudo[2];
                                $param1 = $conteudo[3];//mes
                                $param2 = $conteudo[4];//ano
                                ...
                                $select = "SELECT paciente.nome, paciente.nro_hygia, paciente.data_nascimento, tratamento.data_tratamento_atual, tratamento.data_notificacao, supervisionamento.data_supervisionamento, supervisionamento.comparecimento
                                            ...
                                            WHERE paciente.cod_paciente = $cod_pac
                                            AND paciente.cod_paciente = tratamento.cod_paciente
                                       ...
                                       //$nome = ucfirst($l[0]);
                                        ...
                                        if($nome_ant != $nome){
											...
											*/
                                                ...
                                                //$data_supervisao = ucfirst($l[5]);
                                                //$comp = ucfirst($l[6]);
												$data_supervisao = $consulta['data_supervisionamento'];
                                        ...
                                        <?php  $nome_ant=$nome; //}
                                            ...
                                            <?php } else if ($comp == "N") { $n++; ?>  
                                                ...
                                                <td><td bgcolor="yellow"><b><font size="2"> <?= $d1[2]; ?> (O)</font></b> </td>
                                                <?php
                                            }
                                        }
